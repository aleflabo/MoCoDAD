...
class ST_GCNN_layer(nn.Module):
    ...
    def __init__(self, in_channels:int, out_channels:int, kernel_size:Union[Tuple[int], List[int]],
                 stride:int, time_dim:int, joints_dim:int, dropout:float, bias:bool=True, emb_dim:int=256):
    ...
    def build_model(self) -> None:
        ...
        self.gcn=ConvTemporalGraphical(self.time_dim, self.joints_dim) # the convolution layer
